...
const EMPTY_CONTEXT: CalendarContextValue = {
  ...
  fetchEvents: async () => {},
  getEvent: async () => null,
  createEvent: async () => ({ success: false, error: DISABLED_MESSAGE }),
  updateEvent: async () => ({ success: false, error: DISABLED_MESSAGE }),
  deleteEvent: async () => ({ success: false, error: DISABLED_MESSAGE }),
  toggleComplete: async () => ({ success: false, error: DISABLED_MESSAGE }),
  extractEventsFromEmail: async () => ({
    success: false,
