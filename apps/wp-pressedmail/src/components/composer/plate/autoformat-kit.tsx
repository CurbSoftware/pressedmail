...
/**
 * Text substitutions (template autoformat-kit.tsx port): arrows, legal marks,
 * fractions, comparisons, smart quotes, sub/superscript digits. Built on
 * platejs-core input rules, no extra dependency. Disabled inside code
 * blocks.
 */
...
const createAutoformatTextSubstitutionRule = ({
  ...
  createTextSubstitutionInputRule({
    enabled: ({ editor }) =>
      !isTextSubstitutionBlocked(editor) &&
      getUserPreferencesSnapshot().composer_typography_auto_format,
    patterns,
  });
