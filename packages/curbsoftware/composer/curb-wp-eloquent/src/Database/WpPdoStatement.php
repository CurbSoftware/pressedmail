...
class WpPdoStatement extends \PDOStatement
{
    ...
    function execute($params = null)
    {
        ...
        // SELECT returns rows; INSERT/UPDATE/DELETE leave last_result empty.
        // Capture the write count now, before another query changes wpdb state.
        $this->resultCount = count($this->result) ?: (int) $this->pdo->getWpdb()->rows_affected;
