...
// Template lib/block-discussion-index.ts, verbatim except import paths.

import { CommentPlugin } from '@kit/plate/comment/react';

import type { TResolvedSuggestion } from '@kit/plate/suggestion';
import { getSuggestionKey, keyId2SuggestionId } from '@kit/plate/suggestion';
...
import { useEditorRef, useEditorVersion, usePluginOption } from '@kit/plate/react';
...
const toResolvedSuggestion = ({
  ...
  // Non-null: the empty case returned above (this app builds with
  // noUncheckedIndexedAccess; the template source does not).
