...
export const Header: React.FC<HeaderProps> = function ({
  ...
  return (
    <div
      className={cn(
        'site-header bg-background/80 dark:bg-background/80 border-border/80 sticky top-0 z-[100] w-full border-b-1 shadow-sm backdrop-blur-lg dark:border-b-0 dark:shadow-none',
        className,
      )}
      {...props}
    >
