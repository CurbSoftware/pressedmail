...
namespace CurbSoftware\WpEloquent\Database\Schema;

use BadMethodCallException;
use Closure;
use CurbSoftware\WpEloquent\Database\Connection;
use CurbSoftware\WpEloquent\Database\Eloquent\Model;
use CurbSoftware\WpEloquent\Database\Query\Expression;
use CurbSoftware\WpEloquent\Database\Schema\Grammars\Grammar;
use CurbSoftware\WpEloquent\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \CurbSoftware\WpEloquent\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \CurbSoftware\WpEloquent\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @param  \CurbSoftware\WpEloquent\Database\Connection  $connection
     ...
     *
     * @return \CurbSoftware\WpEloquent\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \CurbSoftware\WpEloquent\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \CurbSoftware\WpEloquent\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \CurbSoftware\WpEloquent\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \CurbSoftware\WpEloquent\Database\Eloquent\Model|string  $model
