  ...
  function ImageUploadInputComponent({
    ...
    const onInputChange: React.ChangeEventHandler<HTMLInputElement> =
      useCallback(
        ...
        [onChange, onValueChange, state.image],
      );
    ...
    if (!visible) {
      return <Input {...props} onChange={onInputChange} ref={setRef} />;
    }
    ...
    return (
      ...
      >
        <Input {...props} ref={setRef} onChange={onInputChange} />
